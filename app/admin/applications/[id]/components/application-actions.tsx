...
export default function ApplicationActions({
	applicationId,
	currentStatus,
}: { applicationId: string; currentStatus: string }) {
	const [isDialogOpen, setIsDialogOpen] = useState(false);
	const [actionType, setActionType] = useState<
		"accept" | "reject" | "request-info" | null
	>(null);
	...
	const confirmAction = async () => {
		...
		console.log(
			`Confirmed action: ${actionType} for application ${applicationId}`,
		);
					...
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							...
							{actionType === "request-info" &&
								"Are you sure you want to request more information?"}
